        ...
        <form id="form" class="form-wrapper" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-body">
                ...
                <div class="row">
                    <div class="form-row">
                        <label>Address</label>
                        <textarea x-model="form.address" cols="30" rows="2" placeholder="Enter address"></textarea>
                    </div>
                </div>
                <div class="row-3">
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" x-model="form.linkedin" :disabled="form.disabled"
                ...
                <div class="row">
                    <div class="form-row">
                        ...
                        <div class="map relative overflow-hidden" @click="onAddMap()">
                            ...
                            <div
                                class="cursor-pointer absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-zinc-50 z-10 opacity-0">
                                <div class="grid place-items-center place-content-center gap-3">
                                    <i class="w-7 h-7" data-feather="map-pin"></i>
                                    <span>Click to add Google Embed map</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('script')
    <script type="module">
        Alpine.data('form_data', () => ({
            form: new FormGroup({
                page: [@json(config('dummy.page_type.contact_us')), ['required']],
