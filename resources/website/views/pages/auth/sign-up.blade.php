...
@section('auth-content')
    <div class="auth-content" :class="step == 3 ? 'sign-up' : ''" x-data="form">
        <div class="auth-wrapper">
            <form id="form" action="{{ route('website-auth-sign-up-store') }}" method="POST" x-form="submit">
                @csrf
                ...
                <div x-show="step == 3" style="display:none" x-transition:enter.duration.300ms>
                    <h3 class="text-center">@lang('website.form.header.create_account')</h3>
                    <div class="row row-3">
                        <div class="form-row">
                            <label><i data-feather="user"></i>@lang('website.form.label.name')</label>
                            <input type="text" class="form-control" name="name" placeholder="@lang('website.form.placeholder.name')">
                            <span class="error-require flex items-center mt-1" x-show="validate?.name">
                                <i class="mr-1" data-feather="alert-triangle"></i>
                                <small x-text="validate?.name"></small>
                            </span>
                        </div>
                        <div class="form-row">
                            <label><i data-feather="user"></i>@lang('website.form.label.username')</label>
                            <input type="text" class="form-control" name="username" placeholder="@lang('website.form.placeholder.username')"
                                value="{{ old('username') }}">
                            <span class="error-require flex items-center mt-1" x-show="validate?.username">
                                <i class="mr-1" data-feather="alert-triangle"></i>
                                <small x-text="validate?.username"></small>
                            </span>
                        </div>
                    </div>
                    <div class="row row-2">
                    ...
                    <div class="form-submit mt-5">
                        <button type="submit" class="btn btn-primary btn-sign-up">
                            @lang('website.form.button.register')</button>
                    </div>
                </div>
